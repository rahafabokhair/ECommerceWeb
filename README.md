...
```bash 
Cd ECommerceWeb 
git clone https://github.com/rahafabokhair/ECommerceWeb

1- Backend Setup (ASP.NET Core)
•	Open “Ecommerce.API” the solution in Visual Studio / VS Code
...
•	Navigate to “Ecommerce.SPA” (or your Angular project folder)
    cd Ecommerce.SPA 
    npm install 
•	Run the Angular app:
    ng serve --open 
